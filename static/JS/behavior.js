...
function defaultValue(){
    d3.json('static/TOOLS/rigth_data/file.json', function(t){
...
function referenceForHeatMap(){
     ...
     */
    return [{'id' : 0, 'level' : 'notion'},
            {'id' : 1, 'level' : 'application'},
            {'id' : 2,'level' : 'maitrise'},
            {'id' : 3, 'level' : 'expert'}]
}
...
function dataForHeatMap(skill_data){
    /** 
     * sets data for the heat map graph
     * parameter:
     * -----------
     *      skill_data : object
     * return:
...
function drawHeatMap(){
        ...
        //Read the data
        d3.json("static/TOOLS/rigth_data/skillData.json", function(data) {
...
function draw(name = dafaultName){
             ...
             */
            let selected_data = "";
            d3.json('static/TOOLS/rigth_data/skillData.json', function(skill_data_graph) {
            let index;
...
function __mainDraw__(){
             ...
             *      None
             */
            d3.json('static/TOOLS/rigth_data/file.json', function(error, graph){
...
function __chronologicalDrawing__(){
    /** */
    d3.json("static/TOOLS/rigth_data/file.json", function(data){
...
function __writeSkillComment__(name = dafaultName, selected_data){
            ...
            d3.json('static/TOOLS/rigth_data/skillComment.json', function(data){
                const set = data.set;
